document.addEventListener('DOMContentLoaded', function () {
    ...
    //const loveWords = ["Feliz Cumpleaños", "❤️", "Danitza", "💖", "Feliz cumpleaños", "💕", "Los mejores exitos", "💘", "de Attilus", "💓"];
            const loveWords = [
                "Feliz Cumpleaños",
                "🌻",   
                "Danitza",
                "❤️",   
                "Danitza Ayna Condori",
                "❤️",   
                "Los mejores exitos",
                "🎂",   
                "Disfruta tu día",
    ...
    function createLoveExplosion(x, y) {
        ...
        const messages = ["Feliz Cumpeaños", "Para ti", "Danitza", "Feliz Cumpleaños", "de Attilus"];
